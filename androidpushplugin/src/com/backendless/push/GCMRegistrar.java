...
public final class GCMRegistrar
{
  ...
  public static void register( Context context, String senderId, Date expiration )
  {
    RegistrationInfo registrationInfo = getRegistrationInfo( context );

    if( registrationInfo == null )
      requesRegistration( context, senderId, expiration );
    else
  ...
  private static void requesRegistration( Context context, String senderId, Date expiration )
  {
