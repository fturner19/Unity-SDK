...
public class UserService : MonoBehaviour
{
  ...
  private bool mIsLoginFinish = false;
  ...
  void OnGUI()
  {
    ...
    if (mIsLoginFinish)
    {
      ...
      if(mIsLoginSuccess)
        Application.LoadLevel("UserServiceLogin");
      else
    ...
    else
    {
      ...
      GUI.Label(new Rect(left, top, width, height), "User Service", titleStyle);
      ...
      top += MainMenu.MARGIN + height;
      if (GUI.Button(new Rect(left, top, width, height), "Login"))
        Login();
      top += MainMenu.MARGIN + height;
      if (GUI.Button(new Rect(left, top, width, height), "Register"))
        Application.LoadLevel("UserServiceRegister");
      top += MainMenu.MARGIN + height;
  ...
  void Login()
  {
    ...
    Backendless.UserService.Login(mEmail, mPassword, callback);
  }
